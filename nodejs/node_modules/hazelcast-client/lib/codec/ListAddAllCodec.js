...
var REQUEST_TYPE = ListMessageType_1.ListMessageType.LIST_ADDALL;
var RESPONSE_TYPE = 101;
var RETRYABLE = false;
var ListAddAllCodec = /** @class */ (function () {
    function ListAddAllCodec() {
    }
    ListAddAllCodec.calculateSize = function (name, valueList) {
    ...
    ListAddAllCodec.encodeRequest = function (name, valueList) {
    ...
    ListAddAllCodec.decodeResponse = function (clientMessage, toObjectFunction) {
    ...
    return ListAddAllCodec;
}());
exports.ListAddAllCodec = ListAddAllCodec;
//# sourceMappingURL=ListAddAllCodec.js.map