...
var REQUEST_TYPE = ListMessageType_1.ListMessageType.LIST_SIZE;
var RESPONSE_TYPE = 102;
var RETRYABLE = true;
var ListSizeCodec = /** @class */ (function () {
    function ListSizeCodec() {
    }
    ListSizeCodec.calculateSize = function (name) {
    ...
    ListSizeCodec.decodeResponse = function (clientMessage, toObjectFunction) {
