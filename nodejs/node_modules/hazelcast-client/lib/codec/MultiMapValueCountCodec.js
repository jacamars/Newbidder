...
var REQUEST_TYPE = MultiMapMessageType_1.MultiMapMessageType.MULTIMAP_VALUECOUNT;
var RESPONSE_TYPE = 102;
var RETRYABLE = true;
var MultiMapValueCountCodec = /** @class */ (function () {
    function MultiMapValueCountCodec() {
    }
    MultiMapValueCountCodec.calculateSize = function (name, key, threadId) {
    ...
    MultiMapValueCountCodec.decodeResponse = function (clientMessage, toObjectFunction) {
