...
var REQUEST_TYPE = MapMessageType_1.MapMessageType.MAP_EXECUTEONALLKEYS;
var RESPONSE_TYPE = 117;
var RETRYABLE = false;
var MapExecuteOnAllKeysCodec = /** @class */ (function () {
    function MapExecuteOnAllKeysCodec() {
    }
    MapExecuteOnAllKeysCodec.calculateSize = function (name, entryProcessor) {
    ...
    MapExecuteOnAllKeysCodec.encodeRequest = function (name, entryProcessor) {
    ...
    MapExecuteOnAllKeysCodec.decodeResponse = function (clientMessage, toObjectFunction) {
    ...
    return MapExecuteOnAllKeysCodec;
}());
exports.MapExecuteOnAllKeysCodec = MapExecuteOnAllKeysCodec;
//# sourceMappingURL=MapExecuteOnAllKeysCodec.js.map