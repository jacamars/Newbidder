...
var REQUEST_TYPE = MapMessageType_1.MapMessageType.MAP_PUT;
var RESPONSE_TYPE = 105;
var RETRYABLE = false;
var MapPutCodec = /** @class */ (function () {
    function MapPutCodec() {
    }
    MapPutCodec.calculateSize = function (name, key, value, threadId, ttl) {
    ...
    MapPutCodec.encodeRequest = function (name, key, value, threadId, ttl) {
    ...
    MapPutCodec.decodeResponse = function (clientMessage, toObjectFunction) {
...
//# sourceMappingURL=MapPutCodec.js.map