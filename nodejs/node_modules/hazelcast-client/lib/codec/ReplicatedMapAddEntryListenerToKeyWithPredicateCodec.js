...
var REQUEST_TYPE = ReplicatedMapMessageType_1.ReplicatedMapMessageType.REPLICATEDMAP_ADDENTRYLISTENERTOKEYWITHPREDICATE;
...
var ReplicatedMapAddEntryListenerToKeyWithPredicateCodec = /** @class */ (function () {
    ...
    ReplicatedMapAddEntryListenerToKeyWithPredicateCodec.calculateSize = function (name, key, predicate, localOnly) {
    ...
    ReplicatedMapAddEntryListenerToKeyWithPredicateCodec.decodeResponse = function (clientMessage, toObjectFunction) {
    ...
    ReplicatedMapAddEntryListenerToKeyWithPredicateCodec.handle = function (clientMessage, handleEventEntry, toObjectFunction) {
        if (toObjectFunction === void 0) { toObjectFunction = null; }
