...
var REQUEST_TYPE = MapMessageType_1.MapMessageType.MAP_TRYLOCK;
var RESPONSE_TYPE = 101;
var RETRYABLE = true;
var MapTryLockCodec = /** @class */ (function () {
    function MapTryLockCodec() {
    }
    MapTryLockCodec.calculateSize = function (name, key, threadId, lease, timeout, referenceId) {
    ...
    MapTryLockCodec.encodeRequest = function (name, key, threadId, lease, timeout, referenceId) {
    ...
    MapTryLockCodec.decodeResponse = function (clientMessage, toObjectFunction) {
