...
var ClientAuthenticationCustomCodec = /** @class */ (function () {
    ...
    ClientAuthenticationCustomCodec.calculateSize = function (credentials, uuid, ownerUuid, isOwnerConnection, clientType, serializationVersion, clientHazelcastVersion) {
    ...
    ClientAuthenticationCustomCodec.encodeRequest = function (credentials, uuid, ownerUuid, isOwnerConnection, clientType, serializationVersion, clientHazelcastVersion) {
