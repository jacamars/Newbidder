...
var REQUEST_TYPE = QueueMessageType_1.QueueMessageType.QUEUE_ADDLISTENER;
var RESPONSE_TYPE = 104;
var RETRYABLE = false;
var QueueAddListenerCodec = /** @class */ (function () {
    function QueueAddListenerCodec() {
    }
    QueueAddListenerCodec.calculateSize = function (name, includeValue, localOnly) {
    ...
    QueueAddListenerCodec.decodeResponse = function (clientMessage, toObjectFunction) {
    ...
    QueueAddListenerCodec.handle = function (clientMessage, handleEventItem, toObjectFunction) {
        if (toObjectFunction === void 0) { toObjectFunction = null; }
