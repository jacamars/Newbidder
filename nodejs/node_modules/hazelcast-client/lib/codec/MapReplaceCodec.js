...
var REQUEST_TYPE = MapMessageType_1.MapMessageType.MAP_REPLACE;
var RESPONSE_TYPE = 105;
var RETRYABLE = false;
var MapReplaceCodec = /** @class */ (function () {
    function MapReplaceCodec() {
    }
    MapReplaceCodec.calculateSize = function (name, key, value, threadId) {
    ...
    MapReplaceCodec.encodeRequest = function (name, key, value, threadId) {
    ...
    MapReplaceCodec.decodeResponse = function (clientMessage, toObjectFunction) {
    ...
    return MapReplaceCodec;
}());
exports.MapReplaceCodec = MapReplaceCodec;
//# sourceMappingURL=MapReplaceCodec.js.map