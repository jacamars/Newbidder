...
var REQUEST_TYPE = MapMessageType_1.MapMessageType.MAP_PUTIFABSENT;
var RESPONSE_TYPE = 105;
var RETRYABLE = false;
var MapPutIfAbsentCodec = /** @class */ (function () {
    function MapPutIfAbsentCodec() {
    }
    MapPutIfAbsentCodec.calculateSize = function (name, key, value, threadId, ttl) {
    ...
    MapPutIfAbsentCodec.encodeRequest = function (name, key, value, threadId, ttl) {
    ...
    MapPutIfAbsentCodec.decodeResponse = function (clientMessage, toObjectFunction) {
    ...
    return MapPutIfAbsentCodec;
}());
exports.MapPutIfAbsentCodec = MapPutIfAbsentCodec;
//# sourceMappingURL=MapPutIfAbsentCodec.js.map