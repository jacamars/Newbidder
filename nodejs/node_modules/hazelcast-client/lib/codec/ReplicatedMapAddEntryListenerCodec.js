...
var REQUEST_TYPE = ReplicatedMapMessageType_1.ReplicatedMapMessageType.REPLICATEDMAP_ADDENTRYLISTENER;
var RESPONSE_TYPE = 104;
var RETRYABLE = false;
var ReplicatedMapAddEntryListenerCodec = /** @class */ (function () {
    function ReplicatedMapAddEntryListenerCodec() {
    }
    ReplicatedMapAddEntryListenerCodec.calculateSize = function (name, localOnly) {
    ...
    ReplicatedMapAddEntryListenerCodec.encodeRequest = function (name, localOnly) {
    ...
    ReplicatedMapAddEntryListenerCodec.decodeResponse = function (clientMessage, toObjectFunction) {
    ...
    ReplicatedMapAddEntryListenerCodec.handle = function (clientMessage, handleEventEntry, toObjectFunction) {
        if (toObjectFunction === void 0) { toObjectFunction = null; }
    ...
    return ReplicatedMapAddEntryListenerCodec;
}());
exports.ReplicatedMapAddEntryListenerCodec = ReplicatedMapAddEntryListenerCodec;
//# sourceMappingURL=ReplicatedMapAddEntryListenerCodec.js.map