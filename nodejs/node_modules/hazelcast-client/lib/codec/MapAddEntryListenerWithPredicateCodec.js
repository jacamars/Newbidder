...
var REQUEST_TYPE = MapMessageType_1.MapMessageType.MAP_ADDENTRYLISTENERWITHPREDICATE;
var RESPONSE_TYPE = 104;
var RETRYABLE = false;
var MapAddEntryListenerWithPredicateCodec = /** @class */ (function () {
    function MapAddEntryListenerWithPredicateCodec() {
    }
    MapAddEntryListenerWithPredicateCodec.calculateSize = function (name, predicate, includeValue, listenerFlags, localOnly) {
    ...
    MapAddEntryListenerWithPredicateCodec.encodeRequest = function (name, predicate, includeValue, listenerFlags, localOnly) {
    ...
    MapAddEntryListenerWithPredicateCodec.decodeResponse = function (clientMessage, toObjectFunction) {
    ...
    MapAddEntryListenerWithPredicateCodec.handle = function (clientMessage, handleEventEntry, toObjectFunction) {
        if (toObjectFunction === void 0) { toObjectFunction = null; }
...
//# sourceMappingURL=MapAddEntryListenerWithPredicateCodec.js.map