...
var REQUEST_TYPE = MultiMapMessageType_1.MultiMapMessageType.MULTIMAP_TRYLOCK;
var RESPONSE_TYPE = 101;
var RETRYABLE = true;
var MultiMapTryLockCodec = /** @class */ (function () {
    function MultiMapTryLockCodec() {
    }
    MultiMapTryLockCodec.calculateSize = function (name, key, threadId, lease, timeout, referenceId) {
    ...
    MultiMapTryLockCodec.decodeResponse = function (clientMessage, toObjectFunction) {
