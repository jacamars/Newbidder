...
var REQUEST_TYPE = QueueMessageType_1.QueueMessageType.QUEUE_ADDALL;
var RESPONSE_TYPE = 101;
var RETRYABLE = false;
var QueueAddAllCodec = /** @class */ (function () {
    function QueueAddAllCodec() {
    }
    QueueAddAllCodec.calculateSize = function (name, dataList) {
    ...
    QueueAddAllCodec.encodeRequest = function (name, dataList) {
    ...
    QueueAddAllCodec.decodeResponse = function (clientMessage, toObjectFunction) {
    ...
    return QueueAddAllCodec;
}());
exports.QueueAddAllCodec = QueueAddAllCodec;
//# sourceMappingURL=QueueAddAllCodec.js.map