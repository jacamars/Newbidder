    ...
    return(
      sortedCreatives().filter((e) => e.type === "banner").map((row, index) => (
        <tr key={'banner-' + row}>
          ...
          <td key={'banner-owner-' + index} className="text-left">{vx.getCampaignNameById(row.campaign_id)}</td>
    ...
    return(
      sortedCreatives().filter((e) => e.type === "video").map((row, index) => (
        <tr key={'video-' + row}>
          ...
          <td key={'video-owner-' + index} className="text-left">{vx.getCampaignNameById(row.campaign_id)}</td>
          {vx.user.sub_id === 'superuser' &&
  ...
  return(
    sortedCreatives().filter((e) => e.type === "audio").map((row, index) => (
      <tr key={'audio-' + row}>
        ...
        <td key={'audio-owner-' + index} className="text-left">{vx.getCampaignNameById(row.campaign_id)}</td>
        {vx.user.sub_id === 'superuser' &&
  ...
  return(
    sortedCreatives().filter((e) => e.type === "native").map((row, index) => (
      <tr key={'native-' + row}>
        ...
        <td key={'native-owner-' + index} className="text-left">{vx.getCampaignNameById(row.campaign_id)}</td>
        {vx.user.sub_id === 'superuser' &&
