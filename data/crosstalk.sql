...
--
-- ure for table `banner_videos_rtb_standards`
--

DROP TABLE IF EXISTS banner_videos_rtb_standards;

CREATE TABLE banner_videos_rtb_standards (
  banner_video_id SERIAL,
  rtb_standard_id int DEFAULT NULL
);
...
CREATE TABLE targets (
  ...
  domain_targetting varchar(50) DEFAULT NULL,
  geo_latitude double precision DEFAULT NULL,
  geo_longitude double  precision DEFAULT NULL,
  geo_range double precision DEFAULT NULL,
  country text, 
  geo_region text,
  carrier text,
  os text,
  ...
  updated_at timestamp DEFAULT NULL,
  name varchar(255) DEFAULT NULL,
  domains_list_id int DEFAULT NULL,
  PRIMARY KEY (id)
);
