	...
	@BeforeClass
	  ...
	  public void testBannerAd() throws Exception {
		  ...
		  HttpPostGet http = new HttpPostGet();
			...
			assertTrue(cat.contains("IAB6"));
			assertTrue(cat.contains("IAB7"));
