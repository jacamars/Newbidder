...
public class AzerionCrypter {
  ...
  public long decodeDecrypt(String base64Websafe, String b64EncryptKey, String b64IntegrityKey) throws AzerionDecryptingException {
  ...
  public long decodeDecrypt(String base64Websafe, SecretKey encryptKey, SecretKey integrityKey) throws AzerionDecryptingException {
  ...
  public byte[] decrypt(byte[] ciphered, String b64EncryptKey, String b64IntegrityKey) throws AzerionDecryptingException {
  ...
  public byte[] decrypt(byte[] crypted, SecretKey encryptionKey, SecretKey integrityKey)
      throws AzerionDecryptingException {
    ...
    try {
      ...
      for (int i = 0; i < INTEGRITY_SIZE; i++) {
        if (signature[i] != crypted[IV_SIZE + CIPHERTEXT_SIZE + i]) {
          throw new AzerionDecryptingException("Signature does not match.", null);
        }
      }
    } catch (NoSuchAlgorithmException e) {
      throw new RuntimeException("HmacSHA1 not supported.", e);
