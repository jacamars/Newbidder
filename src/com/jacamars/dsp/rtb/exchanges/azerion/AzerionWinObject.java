 ...
 *
 */
public class AzerionWinObject extends WinObject {
	/** Integrity key */
	private static SecretKeySpec integrity;
	/** Encryption key */
	private static SecretKeySpec encryption;
	/** The OpenX encryption object */
	private static final AzerionCrypter crypter = new AzerionCrypter();
	 ...
	 */
	public AzerionWinObject(String hash, String cost, String lat,
