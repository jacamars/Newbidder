 ...
 */
public class AzerionResponse extends BidResponse {

    public AzerionResponse(BidRequest br, Impression imp, Campaign camp, Creative creat,
    ...
    public AzerionResponse(BidRequest br, List<SelectedCreative> multi, int xtime) throws Exception {
        super(br, multi, xtime);
        timestamp = System.currentTimeMillis();
    }

    public AzerionResponse(JsonNode root) {
